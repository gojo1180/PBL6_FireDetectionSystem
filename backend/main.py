...
# Import API Routers
from api.v1 import router_sensors, router_vision, router_alerts, router_auth, router_devices, router_news, router_settings
...
app.include_router(router_settings.router, prefix="/api/v1")
