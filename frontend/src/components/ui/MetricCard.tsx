...
const accentClassMap: Record<string, { text: string; bar: string; iconBg: string }> = {
  'ctp-blue': { text: 'text-primary dark:text-indigo-400', bar: 'bg-primary shadow-[0_0_6px_rgba(99,102,241,0.3)]', iconBg: 'bg-primary/10 dark:bg-primary/20' },
  'ctp-sky': { text: 'text-sky-600 dark:text-sky-400', bar: 'bg-sky-500 shadow-[0_0_6px_rgba(14,165,233,0.3)]', iconBg: 'bg-sky-500/15 dark:bg-sky-500/20' },
  'ctp-sapphire': { text: 'text-cyan-600 dark:text-cyan-400', bar: 'bg-cyan-500 shadow-[0_0_6px_rgba(6,182,212,0.3)]', iconBg: 'bg-cyan-500/15 dark:bg-cyan-500/20' },
  'ctp-teal': { text: 'text-teal-600 dark:text-teal-400', bar: 'bg-teal-500 shadow-[0_0_6px_rgba(20,184,166,0.3)]', iconBg: 'bg-teal-500/15 dark:bg-teal-500/20' },
  'ctp-peach': { text: 'text-amber-600 dark:text-amber-400', bar: 'bg-amber-500 shadow-[0_0_6px_rgba(245,158,11,0.3)]', iconBg: 'bg-amber-500/15 dark:bg-amber-500/20' },
  'ctp-lavender': { text: 'text-violet-600 dark:text-violet-400', bar: 'bg-violet-500 shadow-[0_0_6px_rgba(139,92,246,0.3)]', iconBg: 'bg-violet-500/15 dark:bg-violet-500/20' },
  'ctp-red': { text: 'text-rose-600 dark:text-rose-400', bar: 'bg-rose-500 shadow-[0_0_6px_rgba(244,63,94,0.3)]', iconBg: 'bg-rose-500/15 dark:bg-rose-500/20' },
  'ctp-yellow': { text: 'text-yellow-600 dark:text-yellow-400', bar: 'bg-yellow-500 shadow-[0_0_6px_rgba(234,179,8,0.3)]', iconBg: 'bg-yellow-500/15 dark:bg-yellow-500/20' },
};
