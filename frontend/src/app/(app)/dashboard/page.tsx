  ...
  const memoizedSensorCards = useMemo(() => (
    <div className="relative lg:col-span-2">
      ...
      <div className={`space-y-6 ${isBuffering ? 'opacity-40 grayscale-[0.5] pointer-events-none' : 'transition-all duration-500'}`}>
        ...
        <div>
          <h3 className="text-[11px] font-bold uppercase tracking-widest text-ctp-overlay0 mb-3 flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-ctp-blue"></span>
            Environment
          </h3>
          <div className="grid grid-cols-2 gap-4">
            <MetricCard
              ...
              unit="°C"
              icon={<Thermometer size={20} className="text-ctp-sky" />}
              accent="ctp-sky"
              warn={false}
              variant="environment"
            />
            <MetricCard
              ...
              unit="%"
              icon={<Droplets size={20} className="text-ctp-blue" />}
              accent="ctp-blue"
              warn={false}
              variant="environment"
            />
        ...
        {/* ── Group 2: Gas Sensors — CO, LPG, Smoke, CNG (4 columns on desktop) ── */}
        <div>
          <h3 className="text-[11px] font-bold uppercase tracking-widest text-ctp-overlay0 mb-3 flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-ctp-peach"></span>
            Gas Sensors
          </h3>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <MetricCard
              ...
              unit="ppm"
              icon={<Wind size={20} className="text-ctp-lavender" />}
              accent="ctp-lavender"
            ...
            <MetricCard
              ...
              unit="ppm"
              icon={<Wind size={20} className="text-ctp-peach" />}
              accent="ctp-peach"
            ...
            <MetricCard
              ...
              unit="ppm"
              icon={<Droplets size={20} className="text-ctp-teal" />}
              accent="ctp-teal"
            ...
            <MetricCard
              ...
              unit="ppm"
              icon={<Gauge size={20} className="text-ctp-yellow" />}
              accent="ctp-yellow"
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 p-6 lg:p-8 space-y-6">
        ...
        {/* ── AI Anomaly Detection Bar ── */}
        {calibration && (
          <div className="bg-ctp-mantle border border-ctp-crust rounded-xl p-4 flex flex-col sm:flex-row sm:items-center justify-between shadow-sm gap-4">
